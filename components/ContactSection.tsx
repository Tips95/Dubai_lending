            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+971503506009" className="text-purple-400 hover:text-pink-400">
                    +971 50 350 60 09
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@stepdream.ae" className="text-purple-400 hover:text-pink-400">
                    info@stepdream.ae
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 bg-white/10 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center transition-colors"
                  aria-label="WhatsApp"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-white/60 focus:ring-2 focus:ring-gold-500 focus:border-transparent outline-none transition-all"
                    />
                  </div>
                  <div>
                    <input
                  ...
                  <div>
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-white/60 focus:ring-2 focus:ring-gold-500 focus:border-transparent outline-none transition-all resize-none"
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-bold text-lg hover:from-purple-700 hover:to-pink-700 transition-colors shadow-lg hover:shadow-xl"
                  >
                    Отправить заявку
                  </button>
