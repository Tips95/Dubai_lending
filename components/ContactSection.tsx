      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-white px-4 sm:px-0">
            ...
            >
              <div className="card-3d flex items-start gap-4 sm:gap-5 p-5 sm:p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 transition-all">
